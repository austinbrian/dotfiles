# Generated by Powerlevel10k configuration wizard on 2026-03-04 at 16:35 EST.
...
() {
  ...
  # No default background color -- each segment defines its own (rainbow style).
  ...
  ##################################[ dir: current directory ]##################################
  # Current directory colors (rainbow).
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      # (( $#branch > 32 )) && branch[13,-13]="…"  # disabled — show full branch name
